...
## Diagrama de Classes (Domínio da API) com  Arquitetura da Solução
```
...
Lá incluímos todas os endpoints de CRUD, além de aplicar boas práticas. Sendo assim, caso queira um desafio/referência mais completa é só acessar 👊🤩
